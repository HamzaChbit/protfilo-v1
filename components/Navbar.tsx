            ...
            <div  className='hidden mdl:inline-flex items-center gap-7 ' >
                <ul className='flex text-[13px] gap-7'>
                    <Link href='#home' className='flex items-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link  hover:shadow-green-500 hover:shadow-xl  '     onClick={handelScroll} >
                     ...
                     <Link href='#about' className='flex items-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link    hover:shadow-green-500 hover:shadow-xl  '   onClick={handelScroll} >
                     <motion.li
                        initial={{y:-10,opacity:0}}
                        animate={{y:0,opacity:1}}
                     ...
                     <Link href='#project' className='flex items-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link    hover:shadow-green-500 hover:shadow-xl  '   onClick={handelScroll} >
                     <motion.li
                        initial={{y:-10,opacity:0}}
                        animate={{y:0,opacity:1}}
                     ...
                     <Link href='#contact' className='flex items-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link    hover:shadow-green-500 hover:shadow-md  '     onClick={handelScroll} >
                     <motion.li
                        initial={{y:-10,opacity:0}}
                        animate={{y:0,opacity:1}}
